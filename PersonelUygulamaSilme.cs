...
{
    public partial class PersonelUygulamaSilme : Form
    {
        public PersonelUygulamaSilme()
        {
            InitializeComponent();
        }
        ...
        private void PersonelUygulamaSilme_Load(object sender, EventArgs e)
        {
            baglanti.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sil = new SqlCommand("DELETE from Table_Personal_Listesi where Id=@Id", baglanti);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sil = new SqlCommand("DELETE from Table_Uygulamalar where Id=@Id", baglanti);
